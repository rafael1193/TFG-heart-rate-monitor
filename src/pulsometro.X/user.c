...
void InitApp(void)
{
    ...
    OpenUSART( USART_TX_INT_OFF  & // Desactiva interrupciÛn TX
               USART_RX_INT_OFF  & // Desactiva interrupciÛn RX
               USART_ASYNCH_MODE & // Modo asÌncrono
               USART_EIGHT_BIT   & // Sin bit de paridad
               USART_BRGH_HIGH,    // TransmisiÛn de alta velocidad
               SPBRG              );
